...
target_conclude.tar_builder <- function(target, pipeline, scheduler, meta) {
  ...
  builder_sitrep_meta(target, pipeline, meta)
...
#' @export
builder_sitrep_meta.default <- function(target, pipeline, meta) {
}

builder_sitrep_cancelled <- function(target, pipeline, scheduler) {
  UseMethod("builder_sitrep_cancelled")
}

#' @export
builder_sitrep_cancelled.default <- function(target, pipeline, scheduler) {
}

builder_sitrep_errored <- function(target, pipeline, scheduler) {
  UseMethod("builder_sitrep_errored")
}

#' @export
builder_sitrep_errored.default <- function(target, pipeline, scheduler) {
}
...
builder_handle_error <- function(target, pipeline, scheduler, meta) {
  ...
  builder_sitrep_errored(target, pipeline, scheduler)
...
builder_cancel <- function(target, pipeline, scheduler) {
  ...
  builder_sitrep_cancelled(target, pipeline, scheduler)
}
