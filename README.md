...
For the full picture, read [the short
walkthrough](https://books.ropensci.org/targets/walkthrough.html). To
create a pipeline of your own,
...
2.  Try out one of the other [example
...
3.  Read the rest of [the user
    manual](https://books.ropensci.org/targets/) to learn advanced
    techniques for computationally intense pipelines.
