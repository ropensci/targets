...
* Add a `shortcut` argument to `tar_make()`, `tar_make_clustermq()`, `tar_make_future()`, `tar_outdated()`, and `tar_sitrep()` for shortcutting (#522, %523, @jennysjaarda, @MilesMcBain, @kendonB).
