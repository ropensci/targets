...
If you are using `targets` [with `crew` for distributed computing](https://books.ropensci.org/targets/crew.html), it is recommended to use `nanonext` version `0.8.3.9010` or higher, `mirai` version `0.8.7.9013` or higher, and `crew` version `0.2.0` or higher. If the latest CRAN releases are older, then you can install the development versions from R-universe.
