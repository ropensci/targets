...
A data analysis pipeline is a computational workflow that does statistics or data science. Examples include forecasting customer behavior, simulating a clinical trial, and detecting differential expression from genomics data. A typical pipeline includes several tasks to prepare datasets, run models, and summarize results.
