tar_test("tar_exist_meta()", {
  ...
  dir_create(dirname(path_meta(path_store_default())))
  file.create(path_meta(path_store_default()))
...
tar_test("custom script and store args", {
  ...
  expect_false(tar_exist_meta(store = "example/store"))
  ...
  expect_true(tar_exist_meta(store = "example/store"))
