...
Optionally set `root.dir` to assign a working directory for the document. This makes it easy to create different sub-pipelines from different R Markdown documents.
